    ...
    public partial class FormCadCliente : Form
    {
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            using (MySqlConnection Conexao = new MySqlConnection("Server=127.0.0.1;Port=3306;Database=base_clientes;User=root;Password="))
            {
                ...
                using (MySqlCommand cmd = Conexao.CreateCommand())
                {
                    ...
                    cmd.Parameters.AddWithValue("@documento", maskedTextBox5.Text);
        ...
        private void button7_Click(object sender, EventArgs e)
        {
            using(MySqlConnection Conexao = new MySqlConnection("Server=127.0.0.1;Port=3306;Database=base_clientes;User=root;Password="))
            {
                ...
                using(MySqlCommand cmd = Conexao.CreateCommand())
                {
                    cmd.CommandText = "INSERT INTO clientes(nome, documento) VALUES(@nome, @doc)";

                    cmd.Parameters.AddWithValue("@nome", textBox3.Text);
                    cmd.Parameters.AddWithValue("@doc", maskedTextBox5.Text);
